        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="about-right mb-90">
                        ...
                        <div class="social-share pt-30">
                            <div class="section-tittle">
                                ...
                                <ul>
                                    <li><a href="#"><img src="<?= pathClients('assets/img/news/icon-ins.png') ?>" alt=""></a></li>
                                    <li><a href="#"><img src="<?= pathClients('assets/img/news/icon-fb.png') ?>" alt=""></a></li>
                                    <li><a href="#"><img src="<?= pathClients('assets/img/news/icon-tw.png') ?>" alt=""></a></li>
                                    <li><a href="#"><img src="<?= pathClients('assets/img/news/icon-yo.png') ?>" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <form class="form-contact contact_form mb-80" method="post" id="contactForm" novalidate="novalidate">
                                <div class="row">
                                    <div class="col-12">
